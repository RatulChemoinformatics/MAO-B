...
with tab1:
    ...
    st.success(
        " This module of [**MA0-B-Pred**](https://github.com/RatulChemoinformatics/MAO-B has been built to predict bioactivity and identify potent inhibitors against MA0-B using robust machine learning algorithms. The application has been built by Ratul Bhowmik, Sunil Kumar, and Dr. Bijo Mathew. "
    )
